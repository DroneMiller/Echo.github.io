...
s1.async=true;
s1.src='https://embed.tawk.to/6629668f1ec1082f04e67593/1hs8rh94f';
s1.charset='UTF-8';
...
let listProduct = document.querySelector('.products__container-shop');
...
function renderProducts(products) {
    const listProduct = document.querySelector('.products__container-shop');
